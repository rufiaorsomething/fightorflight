...
public class FightOrFlightCommonConfigs {
    ...
    static {
        ...
        DO_POKEMON_ATTACK_IN_BATTLE = BUILDER.comment("Do aggro Pokemon wait for their target to finish any battles before attacking?").define("do_pokemon_attack_in_battle", false);
